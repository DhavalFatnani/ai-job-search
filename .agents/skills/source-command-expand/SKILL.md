...
description: "Migrated source command `expand`"
---

# source-command-expand

Use this skill when the user asks to run the migrated source command `expand`.
...
- `.Codex/skills/job-application-assistant/01-candidate-profile.md`
- `.Codex/skills/job-application-assistant/02-behavioral-profile.md`
